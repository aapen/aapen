...
KERNEL_UNIT_TESTS = confirm_qemu console_output bcd atomic event heap queue root_hub schedule semaphore stack string synchronize transfer_factory transfer
