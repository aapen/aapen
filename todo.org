* Quality of Life
** NEXT Figure out how to have the system under test exit QEMU
...
X0 points to a 2 a struct of 2 u64's which indicates /why/ the exit is
...
** TODO Consider a two-stage kernel
Stage 1 on the SD card
Stage 2 downloaded via USB after early boot
This will speed up testing on physical hardware
