...
** DONE Migrate board info to use the new bcm mailbox driver.
** DONE Migrate the video driver to use the new bcm mailbox driver
** DONE Migrate GPIO to the new driver model
** DONE Delete ~bsp/raspi3/io.zig~
** DONE Delete ~bsp/raspi3/memory.zig~
** DONE Delete ~bsp/raspi3/memory_map.zig~
** DONE Make main.zig look at the model in the devicetree, use that to pick the right module, then invoke it.
