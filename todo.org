...
- Serial becomes abstract, needs to be supplied with a writech function.
- new directory term/
  - term/out.zig - abstract writer
  - term/uart.zig - implements out, uses root.hal.uart to send chars
  - term/vt220.zig - implements out, translates \n and \? 
